...
class Mapbox_Builder {
    ...
    {   
        ...
        wp_register_script('mapboxjs', 'http://api.tiles.mapbox.com/mapbox.js/v2.2.2/mapbox.js', false, '1.3.2');
        wp_enqueue_script('mapboxjs'); 
        wp_register_style('mapboxcss', 'http://api.tiles.mapbox.com/mapbox.js/v2.2.2/mapbox.css' );
    ...
    public function init($parameters) {
        ...
        $this->params['mapdisabletouchzoom'] = get_option('mapbox_mapdisabletouchzoom', false);
        ...
        $this->params['mapwmslayersdefault']=str_replace(';',',',$this->params['mapwmslayersdefault']);
